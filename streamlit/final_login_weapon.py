...
s.starttls()
s.login("Charithtemp04@gmail.com", "1234")
...
def home_page():
    ...
    st.markdown("<h1 class='title-font'>Welcome to the Weapon Detection System</h1>", unsafe_allow_html=True)
    
    # Using the custom CSS class "big-font" to increase the size of the descriptions
    st.markdown("<div class='big-font'>This application uses advanced YOLOV8 techniques to detect Weapon in images, videos, and live webcams.</div>", unsafe_allow_html=True)
            ...
            for box in boxes:
                ...
                if confidence > 50:
                    ...
                    if classnames[Class] == "weapon":
                        ...
                        s.sendmail("Charithtemp04@gmail.com", "chrithkoka@gmail.com", message)
                        playsound('3.wav')
